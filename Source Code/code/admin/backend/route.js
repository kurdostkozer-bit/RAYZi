...
const commissionRoute = require("./server/commissionRate/commissionRate.route");
route.use("/commission", commissionRoute);

const hostSettlementRoute = require("./server/hostSettlementHistory/hostSettlementHistory.route");
route.use("/hostSettlement", hostSettlementRoute);

const agencySettlementRoute = require("./server/agencySettlementHistory/agencySettlementHistory.route");
route.use("/agencySettlement", agencySettlementRoute);
