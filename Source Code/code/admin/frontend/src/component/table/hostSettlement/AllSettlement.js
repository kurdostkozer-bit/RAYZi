...
import { allHostSettlement } from "../../../store/hostSettlement/hostSettlement.action";
...
import { OPEN_DIALOGUE_SETTLEMENT } from "../../../store//hostSettlement/hostSettlement.type";
...
const AllSettlement = (props) => {
  ...
  useEffect(() => {
    allHostSettlement(startDate, endDate);
  }, [startDate, endDate]);
      ...
      <div className="page-title">
        <div className="row">
          <div className="col-12 col-md-6 order-md-1 order-last">
            <h3 className="mb-3 text-white">Host Settlement</h3>
          </div>
                ...
                <tbody className="text-center">
                  {data?.length > 0 ? (
                    data.map((item, dataIndex) =>
                      item?.history?.map((value, agencyIndex) => (
