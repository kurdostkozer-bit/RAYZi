...
public class ReelsAdapter extends RecyclerView.Adapter<ReelsAdapter.ReelsViewHolder> {
    ...
    public interface OnReelsVideoAdapterListner {
        ...
        void onClickCommentList(ReliteRoot.VideoItem id, int pos);
    ...
    public class ReelsViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int position) {
            ...
            binding.tvCommentCount.setOnClickListener(v -> onReelsVideoAdapterListner.onClickCommentList(reel, position));
...
//            }
            ...
            binding.imgComment.setOnClickListener(v -> onReelsVideoAdapterListner.onClickCommentList(reel, position));
