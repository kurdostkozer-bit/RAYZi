...
import com.example.rayzi.databinding.BottomSheetGameCasinoBinding;
import com.example.rayzi.databinding.BottomSheetGameRocketCrashBinding;
...
public class BottomSheetGameRocketCrash {
    String TAG = "BottomSheetGame";
    BottomSheetGameRocketCrashBinding binding;
    SessionManager sessionManager;

    @SuppressLint("SetJavaScriptEnabled")
    public BottomSheetGameRocketCrash(Context context, String gameUrl) {
        ...
        binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.bottom_sheet_game_rocket_crash, null, false);
...
//        binding.webViewGame.setBackgroundColor(Color.TRANSPARENT);
        WebView.setWebContentsDebuggingEnabled(true);
        bottomSheetDialog.show();
        binding.closeBtn.setOnClickListener(v -> bottomSheetDialog.dismiss());
    }
