    ...
    public void onRequestPermissionsResult(int requestCode, @androidx.annotation.NonNull String[] permissions, @androidx.annotation.NonNull int[] grantResults) {
        ...
        if (requestCode == PERMISSION_REQ_ID) {
            ...
            if (grantResults[0] != PackageManager.PERMISSION_GRANTED || grantResults[1] != PackageManager.PERMISSION_GRANTED || grantResults[2] != PackageManager.PERMISSION_GRANTED || grantResults[3] != PackageManager.PERMISSION_GRANTED) {
                ...
                showLongToast( getString(R.string.need_permissions) + Manifest.permission.READ_EXTERNAL_STORAGE + "/" + Manifest.permission.WRITE_EXTERNAL_STORAGE);
                finish();
                return;
            }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            if (requestCode == PERMISSION_REQ_ID) {
                if (grantResults[0] != PackageManager.PERMISSION_GRANTED || grantResults[1] != PackageManager.PERMISSION_GRANTED || grantResults[2] != PackageManager.PERMISSION_GRANTED || grantResults[3] != PackageManager.PERMISSION_GRANTED) {
                    ...
                    showLongToast(getString(R.string.need_permissions));
                    finish();
                }
            }
        }
    ...
    public void onClickSubmit(View view) {
        ...
        call.enqueue(new Callback<>() {
            ...
            public void onResponse(Call<RestResponse> call, Response<RestResponse> response) {
                if (response.code() == 200) {
                    if (response.body().isStatus()) {
                        Toast.makeText(CreateComplainActivity.this, R.string.complain_send_successfully, Toast.LENGTH_SHORT).show();
                        try {
                            finish();
                        } catch (Exception e) {
                            e.printStackTrace();
                        ...
                        Toast.makeText(CreateComplainActivity.this,  getString(R.string.something_went_wrong_text), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(CreateComplainActivity.this,  getString(R.string.something_went_wrong_text), Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<RestResponse> call, Throwable t) {
                binding.tvSubmit.setEnabled(true);
                customDialogClass.dismiss();
                Log.d(TAG, "onFailure: ClickSubmit  ==" + t.getMessage());
            }
        });
    }
