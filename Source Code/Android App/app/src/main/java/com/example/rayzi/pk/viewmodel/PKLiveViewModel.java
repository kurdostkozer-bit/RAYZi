package com.example.rayzi.pk.viewmodel;
...
import com.example.rayzi.pk.adapter.PKLiveStramCommentAdapter;
...
public class PKLiveViewModel extends ViewModel {
    ...
    public PKLiveStramCommentAdapter pkLiveStramCommentAdapter = new PKLiveStramCommentAdapter();
    ...
    public void initLister() {
        ...
        pkLiveStramCommentAdapter.setOnCommentClickListner((UserRoot.User userDummy) -> clickedComment.setValue(userDummy));
