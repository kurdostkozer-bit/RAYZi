...
//                createDraftNotification(draft);
    ...
    private void createDraftNotification(Draft draft) {
        ...
        PendingIntent pi = PendingIntent.getActivity(
                context, 0, intent, PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
        Notification notification =
    ...
    private boolean doActualWork(
        ...
        Call<RestResponse> call = RetrofitBuilder.createUploadFile(progressListener).uploadRelite(hashMap, body1, body2, body3);
