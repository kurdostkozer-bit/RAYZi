...
public class CommentLikeListActivity extends BaseActivity {
    ...
    public void onBackPressed() {
        ...
        sessionManager.saveBooleanValue("isReturningFromCommentLikeList", true);
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (viewType == COMMENTS) {
            ...
            binding.tvViewType.setText(getString(R.string.comments));
        } else {
            binding.lytBottom.setVisibility(View.GONE);
            binding.tvViewType.setText(R.string.likes);
        }
    }
                    ...
                    public void onResponse(Call<RestResponse> call, Response<RestResponse> response) {
                        if (response.code() == 200) {
                            if (response.body() != null && response.body().isStatus()) {
                                ...
                                commentsItem.setTime(getString(R.string.just_now));
