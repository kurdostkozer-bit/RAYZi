...
import com.example.rayzi.databinding.BottomSheetGameAviatorBinding;
...
public class BottomSheetGameAviator {
    String TAG = "BottomSheetGame";
    BottomSheetGameAviatorBinding binding;
    SessionManager sessionManager;

    @SuppressLint("SetJavaScriptEnabled")
    public BottomSheetGameAviator(Context context, String gameUrl) {
        ...
        binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.bottom_sheet_game_aviator, null, false);
