...
public class OneToOneFragment extends BaseFragment {
    ...
    private void initView() {
        ...
        binding.malePrice.setText(String.valueOf(sessionManager.getSetting().getMaleCallCharge()));
        binding.femalePrice.setText(String.valueOf(sessionManager.getSetting().getFemaleCallCharge()));
                    ...
                    public void run() {
                        try {
                            ...
                            if (!cameraProvider.hasCamera(cameraSelector)) {
                                // Handle case where no camera is available for the selected CameraSelector
                                Toast.makeText(requireActivity(), "Camera not found", Toast.LENGTH_SHORT).show();
                                return;
                            }
