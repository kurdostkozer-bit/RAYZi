...
import com.example.rayzi.utils.like.LikeButton;
import com.example.rayzi.utils.like.OnLikeListener;
...
public class FeedAdapter extends RecyclerView.Adapter<FeedAdapter.FeedViewHolder> {
    ...
    public class FeedViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int position) {
            ...
            Log.d(TAG, "setData: postDummy.getAvatarFrameImage() ==  " + postDummy.getAvatarFrameImage());
            binding.imgUser.setUserImage(postDummy.getUserImage(), postDummy.getAvatarFrameImage(), 16);

            if (postDummy.getLocation() == null) {
            ...
            binding.tvCaption1.setText(postDummy.getCaption());
            ...
            binding.tvComments.setText(postDummy.getComment() +" "+context.getString(R.string.comments));
            binding.tvLikes.setText(postDummy.getLike() +" "+ context.getString(R.string.likes));
