...
//                    LogMessage.v("videoTrimResultLauncher data is null");
    ...
    private double getTotalSegmentsSizeInMB(List<RecordSegment> segments) {
        long totalSize = segments.size();

        double sizeInMB = (double) totalSize / (1024 * 1024); // Divide by 1,048,576 to get size in MB

        Log.d(TAG, "getTotalSegmentsSizeInMB: =============================================" + sizeInMB);
        return sizeInMB;
    }
...
//        try {
//            File f = new File(getFilesDir(), "stickers");
//            @SuppressLint("ResourceType") InputStream inputStream = getResources().openRawResource(R.drawable.logo_watermark); // id drawable
...
//        stickers.addObject(this, BitmapFactory.decodeFile(file.getAbsolutePath()));
    ...
    private void confirmClose() {
        ...
        new PopupBuilder(this).showReliteDiscardPopup(getString(R.string.discard_entire_video), getString(R.string.if_you_go_back_now_you_will_lose_all_the_clips_added_to_your_video),
                getString(R.string.discard_video),  getString(R.string.cancel), () -> finish());
    ...
    private double getFileSizeInMB(Uri fileUri) {
        ...
        returnCursor.close();
        double sizeInMB = (double) size / (1024 * 1024); // Divide by 1,048,576 to get size in MB
        return sizeInMB;
    }
